...
package org.variar.openboard.inputmethod.latin.inputlogic;
...
import org.variar.openboard.inputmethod.compat.SuggestionSpanUtils;
...
import org.variar.openboard.inputmethod.latin.Dictionary;
import org.variar.openboard.inputmethod.latin.DictionaryFacilitator;
import org.variar.openboard.inputmethod.latin.LastComposedWord;
import org.variar.openboard.inputmethod.latin.LatinIME;
import org.variar.openboard.inputmethod.latin.NgramContext;
import org.variar.openboard.inputmethod.latin.RichInputConnection;
import org.variar.openboard.inputmethod.latin.Suggest;
import org.variar.openboard.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import org.variar.openboard.inputmethod.latin.SuggestedWords;
import org.variar.openboard.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import org.variar.openboard.inputmethod.latin.WordComposer;
...
import org.variar.openboard.inputmethod.latin.common.StringUtils;
...
import org.variar.openboard.inputmethod.latin.settings.SettingsValuesForSuggestion;
import org.variar.openboard.inputmethod.latin.settings.SpacingAndPunctuations;
import org.variar.openboard.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import org.variar.openboard.inputmethod.latin.utils.AsyncResultHolder;
import org.variar.openboard.inputmethod.latin.utils.InputTypeUtils;
import org.variar.openboard.inputmethod.latin.utils.RecapitalizeStatus;
import org.variar.openboard.inputmethod.latin.utils.StatsUtils;
import org.variar.openboard.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link org.variar.openboard.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link org.variar.openboard.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link org.variar.openboard.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, org.variar.openboard.inputmethod.latin.SuggestedWords)}.
